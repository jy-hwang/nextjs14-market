...
const User = ({user, currentUserId}: UserProps) => {
  ...
  return (
    <div className='grid grid-cols-[40px_1fr_50px] grid-rows-[40px] gap-3 py-3 px-4 border-b-[1px] hover:cursor-pointer hover:bg-blue-500'>
        ...
        <div className='flex justend text-xs text-gray-500'>
            {latestMessage && (
